...
在專案目錄建立 [`.vscode/settings.json`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/vscode_settings.json)，VS Code 便會在服務啟動時自動彈出轉發通知：
```json
{
...
在 [`vite.config.js`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/vite.config.js) 中加入兩大關鍵設定：
...
```
*(參考範本：[`templates/streamlit_app.py`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/streamlit_app.py) 與 [`templates/start_streamlit.sh`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/start_streamlit.sh))*
...
```
*(參考範本：[`templates/gradio_app.py`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/gradio_app.py))*
...
uvicorn main:app \
  ...
  --proxy-headers
```
*(參考範本：[`templates/fastapi_app.py`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/fastapi_app.py) 與 [`templates/start_fastapi.sh`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/templates/start_fastapi.sh))*
...
本教學提供了一份開箱即用的萬用腳本 [`scripts/universal_start.sh`](https://github.com/gemini960114/f1-docs/blob/main/02-web-service-reverse-proxy/scripts/universal_start.sh)，能自動配發閒置 Port、啟動 tmux、並印出完整的 OOD 存取網址：
...
👉 **下一步**：進入 **[第 03 章：超級電腦運行 Code-Server (VS Code Web)](./03_code_server_on_hpc)**，運用本章學到的反向代理與動態埠技術，打造屬於自己的雲端 IDE！
